import { getAllKKM } from "../../util/js/db.js";
...
const populateTable = () => {
  ...
  headerRow.innerHTML =
    "<th>No</th><th>Kuis/Evaluasi</th><th>KKM</th><th>Aksi</th>";
  ...
  currentPageData.forEach((data, index) => {
    ...
    row.innerHTML = `<td>${startIndex + index + 1}</td><td>${
      ...
      data.kkm
    }</td><td><button class="p-2"><img src="../../assets/image/edit.png" width="20em"></button></td>`;
  });
};
